...
os.system("python name_search.py -algorithm BruteForce -name Hispanic -length 5")
os.system("python name_search.py -algorithm BruteForce -name Hispanic -length 8")
...
os.system("python name_search.py -algorithm Horspool -name Hispanic -length 5")
os.system("python name_search.py -algorithm Horspool -name Hispanic -length 8")
